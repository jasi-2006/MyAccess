...
export function buildCarnetPairHtml(learner, card) {
  ...
  const front = `
    <div class="carnet-card" style="width:${CARNET_WIDTH_PX}px;height:${CARNET_HEIGHT_PX}px;border-radius:20px;border:1px solid #D0D0D0;background:#FFFFFF;box-sizing:border-box;display:flex;flex-direction:column;font-family:Arial,Helvetica,sans-serif;position:relative;overflow:hidden;box-shadow:0 6px 14px rgba(0,0,0,0.08);padding:12px 14px;-webkit-print-color-adjust:exact;print-color-adjust:exact;">
      ...
      <div style="font-size:10px;color:#000000;text-transform:uppercase;letter-spacing:0.4px;font-weight:400;line-height:14px;margin-bottom:3px;">
        ${roleDisplay}
      </div>
      <div style="height:3px;background:#008542;margin-bottom:10px;"></div>

      <div style="font-size:16px;font-weight:700;color:#008542;line-height:22px;margin-bottom:5px;">
        ${nameHtml}
      </div>
      <div style="font-size:12px;color:#000000;font-weight:400;margin-bottom:8px;">
      ...
      <div style="font-size:11px;color:#000000;font-weight:400;line-height:13px;margin-top:3px;">${program}</div>
      <div style="font-size:11px;color:#000000;font-weight:400;line-height:13px;margin-top:2px;">Grupo No ${ficha}</div>
    </div>`;
