    ...
    <View style={styles.screen}>
      ...
      <View style={styles.contentFrame}>
        ...
        <ScrollView
          ...
          contentContainerStyle={[styles.mainScroll, { paddingHorizontal: pagePadding, minHeight: height - 78 }]}
...
const styles = StyleSheet.create({
  ...
  mainArea:     { flex: 1 },
  mainScroll:   { flexGrow: 1, paddingTop: 8, paddingBottom: 24 },
  headerBlock:  { marginBottom: 16 },
  pageTitle:    { fontSize: 22, fontWeight: '800', color: '#151515', marginBottom: 2 },
  pageSubtitle: { maxWidth: 400, fontSize: 13, lineHeight: 17, color: '#2C2C2C' },
});
